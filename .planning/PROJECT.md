...
---
*Last updated: 2026-07-11 after Phase 20 (Evaluator Independence, v0.8.0) — IND-01..03 shipped and moved to Validated: judge≠producer enforced at both the judge.py CLI and the compound_eval chokepoint (WR-01 hardened), multi-judge aggregation with Wilson-CI pass-rate, compounding_score authority intact. Active now WIKI/VERD (phases 21–22).*
