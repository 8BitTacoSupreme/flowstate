...
---
*Last updated: 2026-07-12 after Phase 23 (Linux Parity + Core Seam, v0.9.0) — SBX-01..02 shipped and moved to Validated: `flowstate/sandbox.py` seam + observe/denylist + macOS SBPL & Linux bwrap+landlock builders; Linux spike PARITY PROVEN; code review found + fixed a Critical (unchecked landlock syscall returns) + 8 warnings; 1302 tests @ 91.33%. Next: Phase 24 (thread the seam into call sites + config). v0.8.0 Phase-22 verdict debt still parked/owed.*
