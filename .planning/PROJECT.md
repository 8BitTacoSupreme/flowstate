...
---
*Last updated: 2026-07-11 after Phase 21 (Activate the Wiki, v0.8.0) — WIKI-03..06 shipped and moved to Validated, discharging the long-dormant WIKI-F1 layer: production flowstate distiller + flowstate distill CLI, opt-in wiki_layer flag firing the semantic layer (byte-identical default), graceful [semantic]-absent degrade, dogfood proof. Active now VERD (phase 22, the verdict).*
