...
- [x] **Phase 11: Semantic Wiki Retrieval** — Wire per-run semantic top-k wiki retrieval into `context_prefix` with byte-identical default path preserved (completed 2026-06-18)
...
**Plans**: 1 plan
  - [x] 11-01-PLAN.md — Semantic top-k wiki retrieval helper + opt-in wiki-branch wiring with byte-identical default path and embedder-absent static fallback + offline tests (WIKI-01, WIKI-02)
